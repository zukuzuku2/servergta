...
Config.Strings = {
	ExitVehicle = "Salga del vehiculo a repostar",
	EToRefuel = "Presione ~g~E ~w~para repostar el vehiculo",
	JerryCanEmpty = "El bidon esta vacio",
	FullTank = "El tanque esta lleno",
	PurchaseJerryCan = "Presione ~g~E ~w~para comprar un bidon por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Presione ~g~E ~w~para cancelar el llenado del tanque",
	CancelFuelingJerryCan = "Presione ~g~E ~w~para cancelar el llenado del bidon",
	NotEnoughCash = "No tiene suficiente dinero",
	RefillJerryCan = "Presione ~g~E ~w~ para rellenar el bidon por ",
	NotEnoughCashJerryCan = "No tiene suficiente dinero para rellenar el bidon",
	JerryCanFull = "El bidon está lleno",
	TotalCost = "Costo",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presione ~g~E ~w~para agarrar el bidon"
	Config.Strings.RefillJerryCan = "Presione ~g~E ~w~ para rellenar el bidon"
end
